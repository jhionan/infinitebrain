...
// PingRequest carries the message to echo.
...
// PingResponse carries the echoed message.
...
const file_ping_v1_ping_proto_rawDesc = "" +
	...
	"\vPingService\x123\n" +
	"\x04Ping\x12\x14.ping.v1.PingRequest\x1a\x15.ping.v1.PingResponseB\x8c\x01\n" +
	"\vcom.ping.v1B\tPingProtoP\x01Z5github.com/rian/infinite_brain/api/gen/ping/v1;pingv1\xa2\x02\x03PXX\xaa\x02\aPing.V1\xca\x02\aPing\\V1\xe2\x02\x13Ping\\V1\\GPBMetadata\xea\x02\bPing::V1b\x06proto3"
